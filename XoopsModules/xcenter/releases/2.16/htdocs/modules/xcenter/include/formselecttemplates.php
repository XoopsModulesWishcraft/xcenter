...
class XoopsFormSelectTemplates extends XoopsFormElement
{
    ...
    function XoopsFormSelectTemplates($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('', _XTR_NONE);
		xoops_load('xoopslists');
		$html_files = XoopsLists::getHtmlListAsArray($GLOBALS['xoops']->path(_XTR_PATH_PREDEFINED_HTML));
		$rss_files = XoopsLists::getHtmlListAsArray($GLOBALS['xoops']->path(_XTR_PATH_PREDEFINED_RSS));
