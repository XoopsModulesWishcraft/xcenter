...
*/
	...
	define('_XTR_UPGRADE', 'include/upgrade.php');		
	...
	define('_XTR_ADMIN_INDEX', 'admin/index.php');
	...
	define('_XTR_FORCECPANELJQUERY_DESC', 'Forces the installed runtime copy of JQuery 1.3.2');
	define('_XTR_FORCEJQUERY', 'Force JQuery on Content Pages');
	define('_XTR_FORCEJQUERY_DESC', 'Forces the installed runtime copy of JQuery 1.3.2');
	...
	//BlOCKS
	define('_XTR_PAGE', 'Section on page');
